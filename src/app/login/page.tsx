        ...
        <div className="flex items-center justify-center">
          <Card className="w-full max-w-md bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm border-slate-200/50 dark:border-slate-700/50">
            ...
            <CardFooter className="flex flex-col gap-3">
              ...
              <Button variant="outline" className="w-full h-12 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700" disabled={isSubmitting}>
              ...
              <div className="text-center pt-4 border-t border-slate-200 dark:border-slate-700">
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">Demo Access</p>
                <Button 
                  variant="secondary" 
                  className="w-full bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-600"
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                  Email: demo@emergentfortuity.com | Password: demo123
                </p>
              </div>
            </CardFooter>
          </Card>
